...
export default function Step9() {
  ...
  const onSubmit = async (data) => {
    ...
    const sendData = {
      ...
      leadherkunft: "https://bc-rechner.solar-pvcheck.de",
    ...
    <div data-show={step == 9 ? true : false} className="step">
      ...
      <form ref={myForm} onSubmit={handleSubmit(onSubmit)} className="  mt-7">
        ...
        <div className="flex space-x-4">
          <button
            type="submit"
            className="mt-4 bg-green-1 items-center justify-center flex outline-none relative lg:px-12 lg:text-base md:px-8 font-visby font-bold py-3 rounded-md hover:cursor-pointer text-[#F1C88B] transition-all ease-in-out duration-150 hover:bg-opacity-90 hover:shadow-md hover:shadow-[#3d8266] md:text-sm md:w-auto text-sm w-full">
